...
if("TRUE" STREQUAL "TRUE")
  set(deepracer_simulation_SOURCE_PREFIX /home/inspacehj/dr_logger/simulation_ws/src/deepracer_simulation)
  set(deepracer_simulation_DEVEL_PREFIX /home/inspacehj/dr_logger/simulation_ws/build/deepracer_simulation/devel)
  ...
  set(deepracer_simulation_INSTALL_PREFIX /home/inspacehj/dr_logger/simulation_ws/install/deepracer_simulation)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'deepracer_simulation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/inspacehj/dr_logger/simulation_ws/src/deepracer_simulation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT deepracer_simulation_NUM_DUMMY_TARGETS)
      set(deepracer_simulation_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::deepracer_simulation::wrapped-linker-option${deepracer_simulation_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR deepracer_simulation_NUM_DUMMY_TARGETS "${deepracer_simulation_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::deepracer_simulation::wrapped-linker-option${deepracer_simulation_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND deepracer_simulation_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/inspacehj/dr_logger/simulation_ws/build/deepracer_simulation/devel/lib;/home/inspacehj/drone_mpc_ws/devel/.private/catkin_tools_prebuild/lib;/home/inspacehj/drone_ws/devel/.private/catkin_tools_prebuild/lib;/home/inspacehj/drone_mpc_ws/devel/lib;/home/inspacehj/autosim_ws/devel/lib;/home/inspacehj/catkin_ws/devel/lib;/home/inspacehj/drone_ws/devel/lib;/opt/ros/melodic/lib)
...
set(deepracer_simulation_EXPORTED_TARGETS "")
